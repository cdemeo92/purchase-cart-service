...
- **Matches CI/CD pipeline environment** – the Dev Container uses the same `node:24-alpine` image as Docker and CI, so local development matches where pipeline jobs run
